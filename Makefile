...
OPTIONS := ATCAPRINTF ATCA_HAL_I2C ATCA_RASPBERRY_PI_3 ENGINE_DYNAMIC_SUPPORT USE_ECCX08 ATCA_OPENSSL_ENGINE_STATIC_CONFIG ATCA_OPENSSL_ENGINE_ENABLE_CERTS
